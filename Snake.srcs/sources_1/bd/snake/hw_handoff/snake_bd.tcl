...
################################################################
# This is a generated script based on design: snake
#
...
# source snake_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# SNES, buttons, display_timing, showOnLED, snakeController
...
proc create_root_design { parentCell } {
  ...
  set snesClock [ create_bd_port -dir O snesClock ]
  set snesData [ create_bd_port -dir I snesData ]
  set snesLatch [ create_bd_port -dir O snesLatch ]
  set sysclk [ create_bd_port -dir I sysclk ]

  # Create instance: SNES_0, and set properties
  set block_name SNES
  set block_cell_name SNES_0
  if { [catch {set SNES_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
  ...
  # Create instance: display_timing_0, and set properties
  set block_name display_timing
  set block_cell_name display_timing_0
  if { [catch {set display_timing_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $display_timing_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  # Create instance: showOnLED_0, and set properties
  set block_name showOnLED
  set block_cell_name showOnLED_0
  if { [catch {set showOnLED_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $showOnLED_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: snakeController_0, and set properties
  set block_name snakeController
  set block_cell_name snakeController_0
  if { [catch {set snakeController_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $snakeController_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_net -net display_timing_0_de [get_bd_pins display_timing_0/de] [get_bd_pins rgb2dvi_0/vid_pVDE]
  connect_bd_net -net display_timing_0_hs [get_bd_pins display_timing_0/hs] [get_bd_pins rgb2dvi_0/vid_pHSync]
  connect_bd_net -net display_timing_0_vs [get_bd_pins display_timing_0/vs] [get_bd_pins rgb2dvi_0/vid_pVSync]
  connect_bd_net -net display_timing_0_x [get_bd_pins display_timing_0/x] [get_bd_pins snakeController_0/x]
  connect_bd_net -net display_timing_0_y [get_bd_pins display_timing_0/y] [get_bd_pins snakeController_0/y]
  ...
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rgb2dvi_0/aRst_n]
  connect_bd_net -net showOnLED_0_leds [get_bd_ports leds] [get_bd_pins showOnLED_0/leds]
  connect_bd_net -net snakeController_0_data [get_bd_pins rgb2dvi_0/vid_pData] [get_bd_pins snakeController_0/data]
  connect_bd_net -net snesData_0_1 [get_bd_ports snesData] [get_bd_pins SNES_0/snesData]
  connect_bd_net -net sysclk_0_1 [get_bd_ports sysclk] [get_bd_pins SNES_0/sysclk] [get_bd_pins buttons_0/clk] [get_bd_pins showOnLED_0/sysclock]
